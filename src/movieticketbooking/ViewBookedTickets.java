...
public class ViewBookedTickets extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewBookedTickets frame = new ViewBookedTickets("");
	...
	public ViewBookedTickets(String username)  {
		...
		JLabel lblName = new JLabel("VIEW BOOKED TICKET DETAILS");
