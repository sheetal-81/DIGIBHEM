...
public class Signup extends JFrame implements ActionListener{
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] { "Your NickName?", "Your standard?",
			"Your Hero?", "Your ideal ?" }));
	...
	contentPane.add(lblSecurityQuestion);
        ...
        ImageIcon c1 = new ImageIcon(ClassLoader.getSystemResource("icon/fourth.jpeg"));
