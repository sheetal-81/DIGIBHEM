...
public class BookTickets extends JFrame {
	...
	public BookTickets(String username) {
		setBounds(420, 220, 1100, 600);
		contentPane = new JPanel();
		setContentPane(contentPane);
		contentPane.setLayout(null);
                
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("Icon/pngtree.jpg"));
		...
		JLabel lblName = new JLabel("BOOK Tickets");
		...
		contentPane.add(l1);
                ...
                JLabel lblId = new JLabel("Select  :");
		...
		contentPane.add(lblId);
                ...
                try{
                    ...
                    ResultSet rs = c.s.executeQuery("select * from Ticket");
                    while(rs.next()){
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                String q1 = "insert into bookTicket values('"+l1.getText()+"', '"+c1.getSelectedItem()+"', '"+t1.getText()+"', '"+t2.getText()+"', '"+c2.getSelectedItem()+"', '"+c3.getSelectedItem()+"', '"+l2.getText()+"', '"+l3.getText()+"', '"+l4.getText()+"', '"+l5.getText()+"')";
