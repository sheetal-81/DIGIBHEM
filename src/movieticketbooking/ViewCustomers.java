...
public class ViewCustomers extends JFrame {
	...
	public ViewCustomers() throws SQLException {
		...
		setBounds(580, 220, 1200, 680);
		contentPane = new JPanel();
		contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		setContentPane(contentPane);
		contentPane.setLayout(null);
                
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("Icon/viewall.jpeg"));
                Image i3 = i1.getImage().getScaledInstance(626, 201,Image.SCALE_DEFAULT);
                ImageIcon i2 = new ImageIcon(i3);
                JLabel l1 = new JLabel(i2);
                l1.setBounds(0,450,600,210);
                add(l1);
                
                ImageIcon i4  = new ImageIcon(ClassLoader.getSystemResource("Icon/viewall.jpeg"));
                Image i5 = i4.getImage().getScaledInstance(626, 201,Image.SCALE_DEFAULT);
                ImageIcon i6 = new ImageIcon(i5);
                JLabel l2 = new JLabel(i6);
                l2.setBounds(500,450,600,210);
                add(l2);
